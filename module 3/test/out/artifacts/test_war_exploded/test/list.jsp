...
<%--    <form action="/Test?action=searchByGia" method="get">--%>
<%--        <div class="form-group">--%>
<%--            <label>Loại Mặt Bằng</label>--%>
<%--            <select name="ten_loai_mat_bang" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown"--%>
    ...
    <div class="table-responsive">
        <div class="table-wrapper" style="background-color:#f7f5f2 ">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <th>#</th>
                    <th style="width: 22%;">ten_trang_thai</th>
                    <th>dien_tich</th>
                    <th>tang</th>
                    <th style="width: 16%">ten_loai_mat_bang</th>
                    <th>gia_tien</th>
                    <th style="width: 12%">ngay_bat_dau</th>
                    <th style="width: 12%">ngay_ket_thuc</th>
                    <th>Action</th>
                </tr>
                </thead>
                <tbody>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="/Test?action=delete&ma_mat_bang=${matBang.ma_mat_bang}">
...
<div id="addProModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/Test?action=create" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ma_mat_bang" pattern="(MB[\d]{4})"
                               title="Bạn đã nhập sai định dạng">
                    </div>
                    <div class="form-group">
